...
const page = ({ providers }) => {
  ...
  return (
    <>
      <div className='w-[30vw] bg-slate-400 bg-opacity-15 backdrop-blur-md text-white p-5 rounded-2xl shadow-lg mx-auto my-[15vh]'>

        <div className="loginButtons">
          <div className="p-10 ">

            {/* <button onClick={() => { signIn('github', { callbackUrl: '/dashboard' }); }}
              className="w-[16vw] flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <div className="relative mb-6">
              ...
              <input type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="milesofsupport@email.com" autoComplete='off' />
            </div>

            <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300  rounded-lg text-lg px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-[40%] mx-[30%] font-normal shadow-md ">Get Started</button>

            <div className="flex items-center justify-center gap-[0.5vw]">
              <hr className="w-48 h-[0.3vh] mx-auto my-4 bg-slate-500 border-0 rounded-sm md:my-10 dark:bg-slate-500" />
              <span className='text-[1.3rem]'>or</span>
              <hr className="w-48 h-[0.3vh] mx-auto my-4 bg-slate-500 border-0 rounded-sm md:my-10 dark:bg-slate-500" />
            </div>

            <div className="buttons">
              <button onClick={()=>{signIn('github', { callbackUrl: '/dashboard' })}} type="button" className="mx-[22%] text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
